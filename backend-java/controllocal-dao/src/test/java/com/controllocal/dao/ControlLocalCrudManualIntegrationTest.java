...
public class ControlLocalCrudManualIntegrationTest {
    ...
    private final OportunidadComercialDAO oportunidadDAO = new OportunidadComercialDAOImpl();
    ...
    private void ejecutar() {
        ...
        Persona personaPropietario = crearPersona(TipoDocumentoIdentidad.DNI, "71" + sufijo, "Propietario Demo " + sufijo);
        ...
        cliente.setPersona(crearPersona(TipoDocumentoIdentidad.DNI, "72" + sufijo, "Cliente Demo " + sufijo));
        ...
        oportunidad.setFechaRegistro(LocalDateTime.now());
        oportunidad.setEstado(EstadoOportunidadComercial.ABIERTA);
        oportunidad.setObservaciones("Oportunidad comercial de prueba manual");
        ...
        System.out.println("8. Oportunidad comercial creada: " + oportunidad.getIdOportunidad());
        ...
        System.out.println("9. Interaccion comercial creada: " + interaccion.getIdInteraccion());
        ...
        System.out.println("10. Visita creada: " + visita.getIdVisita());
        ...
        System.out.println("12. Documento de solicitud creado: " + documento.getIdDocumento());
        ...
        System.out.println("13. Evaluacion de solicitud creada: " + evaluacion.getIdEvaluacion());
        ...
        System.out.println("14. Reasignacion creada: " + reasignacion.getIdReasignacion());

        MotivoNoContinuidad motivo = new MotivoNoContinuidad();
        motivo.setFechaHora(LocalDateTime.now());
        motivo.setRazonPrincipal(MotivoNoContinuidadTipo.PRECIO);
        ...
        System.out.println("15. Motivo de no continuidad creado: " + motivo.getIdMotivoNoContinuidad());
    }

    private Persona crearPersona(TipoDocumentoIdentidad tipoDocumento, String numeroDocumento, String nombre) {
    ...
    private UsuarioInterno crearUsuario(String numeroDocumento, String nombreUsuario, RolUsuarioInterno rol) {
        ...
        usuario.setPersona(crearPersona(TipoDocumentoIdentidad.DNI, numeroDocumento, "Usuario " + nombreUsuario));
