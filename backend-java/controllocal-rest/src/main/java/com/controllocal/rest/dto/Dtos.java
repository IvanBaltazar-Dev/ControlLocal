...
public final class Dtos {
    ...
    public record LocalRequest(
            ...
            BigDecimal frente,
            String zonificacion,
            Boolean aptoLicenciaFuncionamiento,
    ...
    public record LocalResponse(
        ...
        public static LocalResponse desde(LocalComercial l, String estadoPublicacion) {
            return new LocalResponse(
                    ...
                    l.getCargaElectricaKw(),
                    l.getNumeroEstacionamientos(),
                    l.getCuotaMantenimiento(),
                    l.getFechaRegistro());
        }
    }
    ...
    public record ProspeccionResponse(
            Long id,
        ...
        public static ProspeccionResponse desde(Prospeccion p) {
            ...
            return new ProspeccionResponse(
                    p.getIdProspeccion(),
                    p.getCodigoProspeccion(),
                    local != null ? local.getIdLocal() : null,
                    local != null ? local.getCodigoLocal() : null,
                    ...
                    local != null ? local.getPrecioReferencial() : null,
                    ...
                    agente != null && agente.getPersona() != null
                            ...
                            : null,
                    codigo(p.getEstado()),
                    codigo(p.getResultadoPropuesta()),
                    p.getFechaContacto(),
                    p.getFechaReunion(),
                    p.getFechaPropuesta(),
                    p.getFechaRecontacto(),
                    p.getObservaciones(),
    ...
    public record OportunidadResponse(
        ...
        public static OportunidadResponse desde(OportunidadComercial o) {
            ...
            return new OportunidadResponse(
                    o.getIdOportunidad(),
                    o.getCodigoOportunidad(),
                    cliente != null ? cliente.getIdCliente() : null,
                    cliente != null && cliente.getPersona() != null
                            ? cliente.getPersona().getNombresORazonSocial() : null,
                    captacion != null ? captacion.getIdCaptacion() : null,
                    captacion != null ? captacion.getCodigoCaptacion() : null,
                    local != null ? local.getDireccion() : null,
                    local != null ? local.getDistrito() : null,
                    agente != null ? agente.getIdAgente() : null,
                    agente != null && agente.getPersona() != null
                            ? agente.getPersona().getNombresORazonSocial() : null,
                    codigo(o.getEstado()),
                    o.getFechaRegistro(),
                    o.getMotivoCierre(),
                    o.getObservaciones(),
    ...
    public record EvaluacionResponse(
        ...
        public static EvaluacionResponse desde(EvaluacionSolicitud e) {
            ...
            return new EvaluacionResponse(
                    ...
                    codigo(e.getResultado()),
                    e.getObservaciones(),
                    broker != null ? broker.getIdBroker() : null,
                    broker != null && broker.getPersona() != null
                            ? broker.getPersona().getNombresORazonSocial() : null,
                    codigo(e.getTipoEvaluacion()),
    ...
    public record AlertaResponse(
        ...
        public static AlertaResponse desde(Alerta a) {
            ...
            return new AlertaResponse(
                    a.getIdAlerta(),
                    codigo(a.getTipo()),
                    codigo(a.getSeveridad()),
                    codigo(a.getEntidadTipo()),
                    a.getEntidadId(),
                    agente != null ? agente.getIdAgente() : null,
                    agente != null && agente.getPersona() != null
                            ? agente.getPersona().getNombresORazonSocial() : null,
    ...
    public record ResultadoVisitaRequest(
            String resultado,
            String observaciones,
            String razonNoContinuidad,
            Integer nivelInteres,
        ...
        public static VisitaResponse desde(Visita v) {
            ...
            return new VisitaResponse(
                    ...
                    agente != null && agente.getPersona() != null
                            ? agente.getPersona().getNombresORazonSocial() : null,
                    v.getNivelInteres(),
                    codigo(v.getObjecionPrincipal()),
                    codigo(v.getOpinionPrecio()),
                    codigo(v.getProximaAccion()));
        }
    }
