...
public final class PasswordHasher {
    ...
    // Utilitario de linea de comandos para generar hashes (semillas y altas manuales).
    public static void main(String[] args) {
        if (args.length != 1) {
            System.out.println("Uso: PasswordHasher <contrasena>");
            return;
        }
        System.out.println(hash(args[0].toCharArray()));
    }
}
