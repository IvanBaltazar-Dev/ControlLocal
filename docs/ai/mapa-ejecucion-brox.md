...
| **E2.2** | La pelota y el orden: `DEPENDE_DE_MI` + `lado`/`paso` + política de 6 criterios | ⬜ **siguiente** |
...
| **E2.5** | El Radar del broker (exige revisar antes «la bandeja no es un tablero») | ⬜ |
