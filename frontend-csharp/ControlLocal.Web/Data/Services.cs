...
public class MockAgenteService : IAgenteService
{
    private static readonly AgenteDto[] Data =
    {
        ...
        new() { Id = 4, Iniciales = "PR", Color = "#00AEEF", Nombre = "Paola Reyes", Email = "preyes@controllocal.pe", NumeroDocumento = "45 002 884", Zona = "Lima Centro", FechaIngresoTexto = "18 Jul 2024", CaptacionesActivas = 7, OportunidadesActivas = 4, EstadoAdministrativo = "Activo" },
